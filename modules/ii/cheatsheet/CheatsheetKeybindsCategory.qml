...
Column {
    ...
    property real columnSpacing: 40 * scale
    property real titleSpacing: 7 * scale
    ...
    StyledText {
        ...
        font.pixelSize: Math.round(Appearance.font.pixelSize.title * root.scale)
    }
        ...
        Repeater {
            ...
            model: {
                if (!root.isCategorized) {
                    return HyprlandKeybinds.flatKeybinds.filter(bind => root.hasDescription(bind) && root.isUncategorized(bind) && !root.containsNonFirstRepetitive(bind));
                }
                return HyprlandKeybinds.flatKeybinds.filter(bind => root.hasDescription(bind) && root.isCategory(bind, root.categoryName) && !root.containsNonFirstRepetitive(bind));
            }
            delegate: BindLine {
    ...
    component BindLine: Row {
        ...
        readonly property int keyPixelSize: Math.round(Config.options.cheatsheet.fontSize.key * root.scale)
        ...
        Row {
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: KeyboardKey {
                        ...
                        pixelSize: bindLine.keyPixelSize
                        horizontalPadding: 6 * root.scale
                    }
                }
                StyledText {
                    id: keybindPlus
                    ...
                    font.pixelSize: bindLine.keyPixelSize
                    text: "+"
                }
                KeyboardKey {
                    id: keybindKey
            ...
            Item {
                ...
                StyledText {
                    ...
                    font.pixelSize: Math.round((Config.options.cheatsheet.fontSize.comment || Appearance.font.pixelSize.smaller) * root.scale)
