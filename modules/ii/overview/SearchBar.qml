...
RowLayout {
    ...
    enum SearchPrefixType { Action, App, Clipboard, Emojis, Ai, Math, ShellCommand, WebSearch, Keybinds, DefaultSearch }
    ...
    MaterialShapeWrappedMaterialSymbol {
        ...
        shape: switch(root.searchPrefixType) {
            ...
            case SearchBar.SearchPrefixType.Ai: return MaterialShape.Shape.Clover4Leaf;
        ...
        text: switch (root.searchPrefixType) {
            ...
            case SearchBar.SearchPrefixType.Ai: return "smart_toy";
